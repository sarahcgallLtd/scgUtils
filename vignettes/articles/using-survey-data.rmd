...
##### ***Efficiently Combine Statistics with `compile()`***
...
##### ***Visualising Crosstabs with `crosstab()`***
...
##### ***Extending `compile()` for Comprehensive Tables***
...
##### ***Visual Representation of Compiled Tables***
