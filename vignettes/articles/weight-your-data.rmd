...
```{r cell-based2, dpi=300, out.width = '100%', fig.height = 4}
...
```{r cell-based7, dpi=300, out.width = '100%', fig.height = 4}
plot_popn(survey_df,
          xVar = "gender",
          yVar = "ageGroup",
...
```{r raking3, dpi=300, out.width = '100%', fig.height = 4}
...
```{r raking5, dpi=300, out.width = '100%', fig.height = 4}
grp_freq(survey_df,
         groups = "vote2019",
...
knitr::kable(vote_results, caption = "Target Results", col.names = c("Party", ""))
```
```{r raked6, dpi=300, out.width = '100%', fig.height = 4}
plot_popn(survey_df,
          xVar = "gender",
          yVar = "ageGroup",
          weight = "wt_raked", # weighted result
